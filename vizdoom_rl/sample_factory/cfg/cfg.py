...
def add_model_args(p: ArgumentParser):
    ...
    p.add_argument(
        "--use_sound",
        action="store_true",
        help="Whether we should use sound.",
    )
    p.add_argument(
        "--audio_encoder",
        default='mel',
        type=str,
        help="Which audio encoder to use",
    )
    p.add_argument(
        "--encoder_mlp_layers",
        default=[512, 512],
...
def add_pbt_args(p: ArgumentParser):
    ...
    p.add_argument(
        ...
        default=64,
        type=int,
        help="Common dimension for GMC. "
    )
    p.add_argument(
        "--gmc_latent_dim",
        default=40,
        type=int,
        help="Latent dimension for GMC. "
    )
    p.add_argument(
        "--gmc_loss_type",
        default="infonce",
        type=str,
        help="Loss type for GMC. "
    )
    ...
    p.add_argument(
        ...
        default=None,
        type=str,
        help="Where to load the GMC model",
    )
    p.add_argument(
        "--gmc_freeze",
        default=True,
        type=str2bool,
        help="Whether to freeze the GMC model",
    )