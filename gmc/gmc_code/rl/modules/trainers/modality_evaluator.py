...
class ModalityEvaluator(LightningModule):
    def __init__(
        self,
        model,
        scenario,
        ...
        super(ModalityEvaluator, self).__init__()
    ...
    def evaluate(self, R, E, experiment_id):
        ...
        DCA_visualization._plot_UMAP_components(
            ...
            experiment_id,
            os.path.join(
                self.trainer.default_root_dir, data_config.input_array_filepath
            ),
            os.path.join(
    ...
    def test_epoch_end(self, outputs):
        ...
        Delaunay_graph = self.evaluate(R[:num_halv_R], R[num_halv_R:], "joint_joint")
        self.log_Delaunay_graph_stats(Delaunay_graph, "joint_joint")
